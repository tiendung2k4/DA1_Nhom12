                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="?act=sua-tour&id=<?= htmlspecialchars($tour['id_tour']) ?>"
                                class="btn btn-sm btn-warning" title="Sửa"><i class="fas fa-edit"></i></a>
                            <a href="index.php?act=xoa-tour&id=<?= $tour['id_tour'] ?>" class="btn btn-sm btn-danger"
                                title="Xóa" onclick="return confirm('Bạn có chắc chắn muốn xóa tour: <?= htmlspecialchars($tour['ten_tour']) ?> không?');"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
